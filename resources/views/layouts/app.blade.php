...
<head>
    ...
    @if($dir == 'rtl')
        <link href="{{ asset('assets/admin/css/bootstrap-rtl.min.css') }}" id="bootstrap-style" rel="stylesheet"
            type="text/css" />
    @else
    ...
    <link href="{{ asset('assets/admin/libs/alertifyjs/build/css/alertify.min.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('assets/admin/libs/alertifyjs/build/css/themes/default.min.css') }}" rel="stylesheet"
        type="text/css" />
...
<body @hasanyrole('staff|vendor') data-topbar="dark" data-layout="horizontal" @endhasanyrole data-topbar="{{ $theme }}">
                    ...
                    <div class="modal-header">
                        <form class="app-search d-block w-100 mt-3" id="global-search-form" autocomplete="off">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control global-search-input" id="global-search-input"
                                    name='search' tabindex="2" placeholder="{{ __('system.crud.search') }}" autofocus>
