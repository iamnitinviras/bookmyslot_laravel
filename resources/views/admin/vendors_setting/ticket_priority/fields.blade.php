...
<div class="row p-3">
    <div class="col-lg-4 mb-2">
        <div class="form-group">
            ...
            <input data-pristine-required-message="{{__('validation.required', ['attribute' => strtolower(trans('system.fields.title'))])}}" value="{{ old('title', $ticket_priority->title??'')}}" type="text" name="title" class="form-control" placeholder="{{ trans('system.fields.title') }}" required>
        </div>
    </div>
