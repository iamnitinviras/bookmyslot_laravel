@extends('layouts.app')
@section('title', __('system.expenses.create.menu'))
@section('content')
    <div class="row">
        ...
        <div class="col-xl-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                        <div class="col-mb-8 col-xl-8">
                            <h4 class="card-title">{{ __('system.expenses.create.menu') }}</h4>
                            <div class="page-title-box pb-0 d-sm-flex">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="{{ route('home') }}">{{ __('system.dashboard.menu') }}</a></li>
                                        <li class="breadcrumb-item "><a href="{{ route('admin.expenses.index') }}">{{ __('system.expenses.menu') }}</a></li>
                                        <li class="breadcrumb-item active">{{ __('system.expenses.create.menu') }}</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                ...
                <form autocomplete="off" novalidate="" action="{{ route('admin.expenses.store') }}" id="pristine-valid" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
