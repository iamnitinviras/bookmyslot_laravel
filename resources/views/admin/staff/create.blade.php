    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-sm-12">
            <div class="card">
                ...
                <form autocomplete="off" novalidate="" action="{{ route('admin.staffs.store') }}" id="pristine-valid" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="card-body">
                            @csrf
                    ...
                    <div class="card-footer bg-transparent border-top text-muted">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="{{ route('admin.staffs.index') }}"class="btn btn-secondary">{{ __('system.crud.cancel') }}</a>
                            </div>
                        </div>
                    </div>
                </form>
