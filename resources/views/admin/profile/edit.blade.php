    ...
    <div class="row">
        <div class="col-xl-12 col-sm-12">
            <div class="card">
                            ...
                            <div class="page-title-box pb-0 d-sm-flex">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('admin.profile') }}">{{ __('system.profile.menu') }}</a></li>
                ...
                <form autocomplete="off" novalidate="" action="{{ route('admin.profile.update') }}" id="pristine-valid" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="card-body">
                            @csrf
                            @method('put')
                                    ...
                                    <div class=" d-flex  align-items-center ">
                                        <div class='mx-3 '>
                                            ...
                                            @if ($user->profile_url != null)
                                                <img src="{{ $user->profile_url }}" alt="" class="avatar-xl rounded-circle img-thumbnail preview-image">
                                            @else
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <div class="mb-3 form-group @error('first_name') has-danger @enderror">
                                        ...
                                        <input type="text" class="form-control start_no_space" id="first_name" placeholder="{{ $lbl_first_name }}" required="" value="{{ old('first_name', $user->first_name) }}" maxlength="50" data-pristine-required-message="{{ __('validation.required', ['attribute' => strtolower($lbl_first_name)]) }}" name="first_name"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3 form-group @error('last_name') has-danger @enderror">
                                        ...
                                        <input type="text" class="form-control start_no_space" id="last_name" placeholder="{{ $lbl_last_name }}" required="" value="{{ old('last_name', $user->last_name) }}" maxlength="50" name="last_name" data-pristine-required-message="{{ __('validation.required', ['attribute' => strtolower($lbl_last_name)]) }}"
                                ...
                                <div class="col-md-4 ">
                                    ...
                                    <div class="mb-3 form-group @error('email') has-danger @enderror">
                                        <label class="form-label" for="first_name">{{ $lbl_email }} <span class="text-danger">*</span></label>
                                        <input type="email" class="form-control start_no_space" id="email" placeholder="{{ $lbl_email }}" required="" value="{{ old('email', $user->email) }}" data-pristine-required-message="{{ __('validation.required', ['attribute' => strtolower($lbl_email)]) }}" name="email">
                                        @error('email')
                                            <div class="pristine-error text-help">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3 form-group @error('phone_number') has-danger @enderror">
                                        ...
                                        <input  onkeypress="return NumberValidate(event);" type="text" class="form-control" id="pristine-phone-valid" placeholder="{{ $lbl_phone_number }}" required value="{{ old('phone_number', $user->phone_number) }}" name="phone_number" data-pristine-required-message="{{ __('validation.required', ['attribute' => strtolower($lbl_phone_number)]) }}">
                                        @error('phone_number')
                                            <div class="pristine-error text-help">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-3 form-group @error('address') has-danger @enderror">
                                        ...
                                        <input name="address" class="form-control" id="input-address" value="{{ old('address', $user->address) }}" placeholder="{{ $lbl_address }}" rows="2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="mb-3 form-group @error('zip') has-danger @enderror">
                                        ...
                                        <input type="text" name="zip" class="form-control pristine-custom-pattern" id="input-zip" placeholder="{{ $lbl_zip }}" maxlength="8" value="{{ old('zip', $user->zip) }}" maxlength="8" data-pristine-pattern-message="{{ __('validation.custom.invalid', ['attribute' => strtolower($lbl_zip)]) }}">
