...
<div class="row">
    <div class="col-xl-12 col-sm-12">
        <div class="card">
                        ...
                        <div class="page-title-box pb-0 d-sm-flex">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('admin.profile') }}">{{ __('system.profile.menu') }}</a></li>
            ...
            <form autocomplete="off" novalidate="" action="{{ route('admin.profile.update') }}" id="pristine-valid"
                    ...
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <div class=" d-flex  align-items-center ">
                                ...
                                <input type="file" name="profile_image" id="profile_image" class="d-none my-preview"
                                    accept="image/*"
                                    data-pristine-accept-message="{{ __('validation.enum', ['attribute' => strtolower($lbl_profile_image)]) }}"
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-4 ">
                            ...
                            <div class="mb-3 form-group @error('first_name') has-danger @enderror">
                                <label class="form-label" for="first_name">{{ $lbl_first_name }} <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control start_no_space" id="first_name"
                                    placeholder="{{ $lbl_first_name }}" required=""
                                    value="{{ old('first_name', $user->first_name) }}" maxlength="50"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3 form-group @error('last_name') has-danger @enderror">
                                <label class="form-label" for="last_name">{{ $lbl_last_name }} <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control start_no_space" id="last_name"
                                    placeholder="{{ $lbl_last_name }}" required=""
                                    value="{{ old('last_name', $user->last_name) }}" maxlength="50" name="last_name"
                        ...
                        <div class="col-md-4 ">
                            ...
                            <div class="mb-3 form-group @error('email') has-danger @enderror">
                                <label class="form-label" for="first_name">{{ $lbl_email }} <span
                                        class="text-danger">*</span></label>
                                <input type="email" class="form-control start_no_space" id="email"
                                    placeholder="{{ $lbl_email }}" required="" value="{{ old('email', $user->email) }}"
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3 form-group @error('phone_number') has-danger @enderror">
                                <label class="form-label" for="pristine-phone-valid">{{ $lbl_phone_number }} <span
                                        class="text-danger">*</span></label>
                                <input onkeypress="return NumberValidate(event);" type="text" class="form-control"
                                    id="pristine-phone-valid" placeholder="{{ $lbl_phone_number }}" required
   ...
   <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="mb-3 form-group @error('address') has-danger @enderror">
                                ...
                                <input name="address" class="form-control" id="input-address"
                                    value="{{ old('address', $user->address) }}" placeholder="{{ $lbl_address }}"
                                    rows="2">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="mb-3 form-group @error('city') has-danger @enderror">
                                ...
                                <input type="text" name="city" class="form-control" id="input-city"
                                    placeholder="{{ $lbl_city }}" value="{{ old('city', $user->city) }}">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="mb-3 form-group @error('state') has-danger @enderror">
                                ...
                                <input type="text" name="state" class="form-control" id="input-state"
                                    placeholder="{{ $lbl_state }}" value="{{ old('state', $user->state) }}">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="mb-3 form-group @error('country') has-danger @enderror">
                                ...
                                <input type="text" name="country" class="form-control" id="input-country"
                                    placeholder="{{ $lbl_country }}" value="{{ old('country', $user->country) }}">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="mb-3 form-group @error('zip') has-danger @enderror">
                                ...
                                <input type="text" name="zip" class="form-control pristine-custom-pattern"
                                    id="input-zip" placeholder="{{ $lbl_zip }}" maxlength="8"
                                    value="{{ old('zip', $user->zip) }}" maxlength="8"
                ...
                <div class="card-footer bg-transparent border-top text-muted">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <a href="{{ route('admin.profile') }}" class="btn btn-outline-primary"><i
                                    class="fa fa-arrow-left"></i> {{ __('system.crud.back') }}</a>
                        </div>
                    </div>
                </div>
            </form>
