                ...
                <tr>
                    <td>
                        @if ($vendor->profile_url != null)
                            <img src="{{ $vendor->profile_url }}" alt="{{ $vendor->name }}" class="avatar-sm rounded-circle me-2 image-object-cover lazyload">
                        @else
                    ...
                    <td>
                        <a class="btn btn-outline-primary" href="{{route('admin.vendors.vendorSignin',['vendor' => $vendor->id])}}">
                    ...
                    <td>
                        ...
                        <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                            <a role="button" href="{{ route('admin.vendors.show', ['vendor' => $vendor->id]) }}" class="btn btn-secondary">{{ __('system.fields.view') }}</a>
                            <a role="button" href="{{ route('admin.vendors.edit', ['vendor' => $vendor->id]) }}" class="btn btn-success">{{ __('system.crud.edit') }}</a>
