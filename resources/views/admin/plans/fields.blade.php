        ...
        <div class="row">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text is-unlimited">
                            <input data-name="member_limit" {{ isset($plan) && $plan->member_unlimited == 'yes' ? 'checked' : '' }} id="is_member_limit" data-target="#member_limit" name="is_member_unlimited" type="checkbox" class="isUnlimited" value="yes">
                            <label for="is_member_limit" class="form-check-label ml-3"> {{ trans('system.plans.is_unlimited') }}</label>
                        </div>
                    </div>
                    <input value="{{ old('member_limit') ? old('member_limit') : (isset($plan) ? $plan->member_limit : 0) }}" type="number" name="member_limit" id="member_limit" class="form-control" required min="0">
                </div>
            </div>
            ...
            <div class="col-lg-4 mb-2">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text is-unlimited">
                            <input data-name="branch_limit" {{ isset($plan) && $plan->branch_unlimited == 'yes' ? 'checked' : '' }} id="is_branch_limit" data-target="#branch_limit" name="is_branch_unlimited" type="checkbox" class="isUnlimited" value="yes">
                            <label for="is_branch_limit" class="form-check-label ml-3"> {{ trans('system.plans.is_unlimited') }}</label>
                        </div>
                    </div>
                    <input value="{{ old('branch_limit') ? old('branch_limit') : (isset($plan) ? $plan->branch_limit : 0) }}" type="number" name="branch_limit" id="branch_limit" class="form-control" required min="0">
                </div>
            </div>
            <div class="col-lg-4 mb-2">
                ...
                <div class="input-group">
                    ...
                    <input value="{{ old('staff_limit') ? old('staff_limit') : (isset($plan) ? $plan->staff_limit : 0) }}" type="number" name="staff_limit" id="staff_limit" class="form-control" required min="0">
                </div>
            </div>
