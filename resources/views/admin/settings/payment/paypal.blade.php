            ...
            <div class="col-md-4 mb-3">
                <div class="form-group">
                    ...
                    <select name="paypal_currency_code" id="paypal_currency_code" required="required"
                        ...
                        <option {{ config('paypal.currency') == 'INR' ? 'selected' : '' }} value="INR">Indian rupee
                        </option>
                        <option {{ config('paypal.currency') == 'AUD' ? 'selected' : '' }} value="AUD">Australian dollar
                        </option>
                        <option {{ config('paypal.currency') == 'BRL' ? 'selected' : '' }} value="BRL">Brazilian real
                        </option>
                        <option {{ config('paypal.currency') == 'CAD' ? 'selected' : '' }} value="CAD">Canadian dollar
                        </option>
                        <option {{ config('paypal.currency') == 'CNY' ? 'selected' : '' }} value="CNY">Chinese Renmenbi
                        </option>
                        <option {{ config('paypal.currency') == 'CZK' ? 'selected' : '' }} value="CZK">Czech koruna
                        </option>
                        <option {{ config('paypal.currency') == 'DKK' ? 'selected' : '' }} value="DKK">Danish krone
                        </option>
                        <option {{ config('paypal.currency') == 'EUR' ? 'selected' : '' }} value="EUR">Euro </option>
                        <option {{ config('paypal.currency') == 'HKD' ? 'selected' : '' }} value="HKD">Hong Kong dollar
                        </option>
                        <option {{ config('paypal.currency') == 'HUF' ? 'selected' : '' }} value="HUF">Hungarian forint
                        </option>
                        <option {{ config('paypal.currency') == 'ILS' ? 'selected' : '' }} value="ILS">Israeli new shekel
                        </option>
                        <option {{ config('paypal.currency') == 'JPY' ? 'selected' : '' }} value="JPY">Japanese yen
                        </option>
                        <option {{ config('paypal.currency') == 'MYR' ? 'selected' : '' }} value="MYR">Malaysian ringgit
                        </option>
                        <option {{ config('paypal.currency') == 'MXN' ? 'selected' : '' }} value="MXN">Mexican peso
                        </option>
                        <option {{ config('paypal.currency') == 'TWD' ? 'selected' : '' }} value="TWD">New Taiwan dollar
                        </option>
                        <option {{ config('paypal.currency') == 'NZD' ? 'selected' : '' }} value="NZD">New Zealand dollar
                        </option>
                        <option {{ config('paypal.currency') == 'NOK' ? 'selected' : '' }} value="NOK">Norwegian krone
                        </option>
                        <option {{ config('paypal.currency') == 'PHP' ? 'selected' : '' }} value="PHP">Philippine peso
                        </option>
                        <option {{ config('paypal.currency') == 'PLN' ? 'selected' : '' }} value="PLN">Polish złoty
                        </option>
                        <option {{ config('paypal.currency') == 'GBP' ? 'selected' : '' }} value="GBP">Pound sterling
                        </option>
                        <option {{ config('paypal.currency') == 'RUB' ? 'selected' : '' }} value="RUB">Russian ruble
                        </option>
                        <option {{ config('paypal.currency') == 'SGD' ? 'selected' : '' }} value="SGD">Singapore dollar
                        </option>
                        <option {{ config('paypal.currency') == 'SEK' ? 'selected' : '' }} value="SEK">Swedish krona
                        </option>
                        <option {{ config('paypal.currency') == 'CHF' ? 'selected' : '' }} value="CHF">Swiss franc
                        </option>
                        <option {{ config('paypal.currency') == 'THB' ? 'selected' : '' }} value="THB">Thai baht </option>
                        <option {{ config('paypal.currency') == 'USD' ? 'selected' : '' }} value="USD">United States
                            dollar </option>
                    </select>
                </div>
            </div>
