@extends('layouts.app')
@section('title', __('system.password.menu'))
@section('content')
    <div class="row">
        <div class="col-xl-12 col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            <form autocomplete="off" novalidate="" action="{{ route('admin.password.update') }}" id="pristine-valid" method="post" enctype="multipart/form-data" class="submit-with-confirm">
                                <div class="row">
                                    @csrf
                                    @method('put')
                                    <div class="col-md-12">
                                        <div class="mb-3 form-group @error('current_password') has-danger @enderror">
                                            ...
                                            <input type="password" class="form-control" id="current_password" placeholder="{{ $lbl_current_password }}" required="" data-pristine-required-message="{{ __('validation.required', ['attribute' => strtolower($lbl_current_password)]) }}" name="current_password">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3 form-group @error('password') has-danger @enderror">
                                            ...
                                            <input type="password" name="password" id="pristine-password-valid" class="form-control"placeholder="{{ $lbl_new_password }}" required data-pristine-required-message="{{ __('validation.required', ['attribute' => strtolower($lbl_new_password)]) }}" data-pristine-password-message="{{ __('validation.password.invalid') }}">
                                            @error('password')
                                                <div class="pristine-error text-help">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3 form-group @error('password_confirmation') has-danger @enderror">
                                            ...
                                            <input type="password" class="form-control" id="pristine-password_confirmation-valid" placeholder="{{ $lbl_password_confirmation }}" name="password_confirmation" required
