...
<div class="auth-content my-auto">
        ...
        <div class="mb-4 form-group">
            <div
                ...
                <input type="password" class="form-control pe-5 " name="password" placeholder="{{ $lbl_password }}"
                    ...
                    data-pristine-password-message="{{ __('validation.password.invalid') }}" value="">
    ...
    <div class="mt-4 pt-2 text-center">
        ...
        <ul class="list-inline mb-0">
            @if (config('custom.facebook_social_login') == 'enable')
                <li class="list-inline-item">
                    <a href="{{ url('login/facebook') }}" class="social-list-item bg-primary text-white border-primary">
                        <i class="mdi mdi-facebook"></i>
                    </a>
                </li>
            @endif
            @if (config('custom.google_social_login') == 'enable')
                <li class="list-inline-item">
