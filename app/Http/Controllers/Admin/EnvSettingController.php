...
{
    public static $timeformate = ['d/m/Y h:i' => ['date' => "d/m/Y", 'time' => 'h:i', 'value' => 'd/m/Y h:i (EX: 02/09/2022 10:37)',], 'd-m-Y h:i' => ['date' => "d-m-Y", 'time' => 'h:i', 'value' => 'd-m-Y h:i (EX: 02-09-2022 10:37)',], 'm-d-Y h:i' => ['date' => "m-d-Y", 'time' => 'h:i', 'value' => 'm-d-Y h:i (EX: 02/09/2022 10:37)',], 'm/d/Y h:i' => ['date' => "m/d/Y", 'time' => 'h:i', 'value' => 'm/d/Y h:i (EX: 09/02/2022 10:37)',], 'Y/m/d h:i' => ['date' => "Y/m/d", 'time' => 'h:i', 'value' => 'Y/m/d h:i  (EX: 2022/09/02 10:37)',], 'Y-m-d h:i' => ['date' => "Y-m-d h:i", 'time' => 'h:i', 'value' => 'Y-m-d h:i  (EX: 2022-09-02 10:37)',],

        'd/m/Y H:i' => ['date' => "d/m/Y", 'time' => 'H:i', 'value' => 'd/m/Y H:i (EX: 02/09/2022 20:37)',], 'd-m-Y H:i' => ['date' => "d-m-Y", 'time' => 'H:i', 'value' => 'd-m-Y H:i (EX: 02-09-2022 20:37)',], 'm-d-Y H:i' => ['date' => "m-d-Y", 'time' => 'H:i', 'value' => 'm-d-Y H:i (EX: 02/09/2022 20:37)',], 'm/d/Y H:i' => ['date' => "m/d/Y", 'time' => 'H:i', 'value' => 'm/d/Y H:i (EX: 09/02/2022 20:37)',], 'Y/m/d H:i' => ['date' => "Y/m/d", 'time' => 'H:i', 'value' => 'Y/m/d H:i  (EX: 2022/09/02 20:37)',], 'Y-m-d H:i' => ['date' => "Y-m-d H:i", 'time' => 'H:i', 'value' => 'Y-m-d H:i  (EX: 2022-09-02 20:37)',],

        'F j, Y, g:i a' => ['date' => "F j, Y", 'time' => 'g:i a', 'value' => 'F j, Y, g:i a (EX: March 10, 2001, 5:16 pm)',], 'Y-m-d H:i:s' => ['date' => "Y-m-d", 'time' => 'H:i:s', 'value' => 'Y-m-d H:i:s (EX: 2001-03-10 17:16:18)',], 'h:i A d/m/Y' => ['date' => "d/m/Y", 'time' => 'h:i A', 'value' => 'h:i A d/m/Y (EX: 17:16 AM 10/03/2022)',], 'd/m/Y h:i A' => ['date' => "d/m/Y", 'time' => 'h:i A', 'value' => 'd/m/Y h:i A (EX: 10/03/2022 17:16 AM)',], 'd F Y, h:i:s A' => ['date' => "d F Y", 'time' => 'h:i:s A', 'value' => 'd F Y, h:i:s A (EX: 13 September 2018, 11:05:00 AM)',],];
    ...
    public function update()
    {
        ...
        $request->validate([
            ...
            "app_name.required" => __('validation.required', ['attribute' => $lbl_app_name]), "app_name.string" => __('validation.custom.invalid', ['attribute' => $lbl_app_name]), "app_name.min" => __('validation.custom.invalid', ['attribute' => $lbl_app_name]),

            "app_dark_logo.max" => __('validation.gt.file', ['attribute' => $lbl_app_dark_logo, 'value' => 10000]), "app_dark_logo.image" => __('validation.enum', ['attribute' => $lbl_app_dark_logo]), "app_dark_logo.mimes" => __('validation.enum', ['attribute' => $lbl_app_dark_logo]),

            "app_light_logo.max" => __('validation.gt.file', ['attribute' => $lbl_app_light_logo, 'value' => 10000]), "app_light_logo.image" => __('validation.enum', ['attribute' => $lbl_app_light_logo]), "app_light_logo.mimes" => __('validation.enum', ['attribute' => $lbl_app_light_logo]),

            "app_favicon_logo.max" => __('validation.gt.file', ['attribute' => $lbl_app_favicon_logo, 'value' => 10000]), "app_favicon_logo.image" => __('validation.enum', ['attribute' => $lbl_app_favicon_logo]), "app_favicon_logo.mimes" => __('validation.enum', ['attribute' => $lbl_app_favicon_logo]),

            "app_timezone.required" => __('validation.required', ['attribute' => $lbl_app_timezone]), "app_timezone.in" => __('validation.enum', ['attribute' => $lbl_app_timezone]),

            "app_defult_language.required" => __('validation.required', ['attribute' => $lbl_app_defult_language]), "app_defult_language.in" => __('validation.enum', ['attribute' => $lbl_app_defult_language]),

            "app_date_time_format.required" => __('validation.required', ['attribute' => $lbl_app_date_time_format]), "app_date_time_format.in" => __('validation.enum', ['attribute' => $lbl_app_date_time_format]),
    ...
    public function emailSave()
    {
        ...
        $request->validate(['app_smtp_host' => ['required', 'min:2'], 'app_smtp_username' => ['required', 'string', 'min:2'], 'app_smtp_password' => ['required', 'string', 'min:2'], 'app_smtp_from_address' => ['required', 'email', 'min:2']], ["app_smtp_host.required" => __('validation.required', ['attribute' => $lbl_app_smtp_host]), "app_smtp_host.string" => __('validation.custom.invalid', ['attribute' => $lbl_app_smtp_host]), "app_smtp_host.regex" => __('validation.custom.invalid', ['attribute' => $lbl_app_smtp_host]),

            "app_smtp_port.required" => __('validation.required', ['attribute' => $lbl_app_smtp_port]), "app_smtp_port.in" => __('validation.enum', ['attribute' => $lbl_app_smtp_port]),

            "app_smtp_encryption.required" => __('validation.required', ['attribute' => $lbl_app_smtp_encryption]), "app_smtp_encryption.in" => __('validation.enum', ['attribute' => $lbl_app_smtp_encryption]),

            "app_smtp_username.required" => __('validation.required', ['attribute' => $lbl_app_smtp_username]), "app_smtp_username.string" => __('validation.custom.invalid', ['attribute' => $lbl_app_smtp_username]), "app_smtp_username.min" => __('validation.custom.invalid', ['attribute' => $lbl_app_smtp_username]),

            "app_smtp_password.required" => __('validation.required', ['attribute' => $lbl_app_smtp_password]), "app_smtp_password.string" => __('validation.custom.invalid', ['attribute' => $lbl_app_smtp_password]), "app_smtp_password.min" => __('validation.custom.invalid', ['attribute' => $lbl_app_smtp_password]),

            "app_smtp_from_address.required" => __('validation.required', ['attribute' => $lbl_app_smtp_from_address]), "app_smtp_from_address.email" => __('validation.custom.invalid', ['attribute' => $lbl_app_smtp_from_address]), "app_smtp_from_address.min" => __('validation.custom.invalid', ['attribute' => $lbl_app_smtp_from_address])
    ...
    public function frontendImages(Request $request)
    {
        ...
        $request->validate(['banner_image_one' => ['max:10000', "image", 'mimes:jpeg,png,jpg,gif,svg,webp'], 'banner_image_two' => ['max:10000', "image", 'mimes:jpeg,png,jpg,gif,svg,webp']], ["banner_image_one.max" => __('validation.gt.file', ['attribute' => $lbl_banner_image_one, 'value' => 10000]), "banner_image_one.image" => __('validation.enum', ['attribute' => $lbl_banner_image_one]), "banner_image_one.mimes" => __('validation.enum', ['attribute' => $lbl_banner_image_one]),

            "banner_image_two.max" => __('validation.gt.file', ['attribute' => $lbl_banner_image_two, 'value' => 10000]), "banner_image_two.image" => __('validation.enum', ['attribute' => $lbl_banner_image_two]), "banner_image_two.mimes" => __('validation.enum', ['attribute' => $lbl_banner_image_two]),]);
