...
class PaypalController extends Controller
{
    public function process($request, $plan)
    {
        ...
        if ($credentials == null) {
            return redirect('subscription')->with('Error', 'Paypal credentials not found.');
        }
    ...
    public function processSuccess(Request $request)
    {
        ...
        if (!$credentials->paypal_client_id || !$credentials->paypal_secret_key) {
            return redirect('subscription')->withErrors(['msg' => trans('system.plans.invalid_payment')]);
        }
        ...
        if (!$payment) return redirect('subscription')->withErrors(['msg' => trans('system.plans.invalid_payment')]);
    ...
    {
        return redirect('subscription')->withErrors(['msg' => "Payment has been cancelled"]);
    }
