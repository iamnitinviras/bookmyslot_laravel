...
function check_permission($element) {
    ...
    if (checked) {
        ...
        if (
            value == "add product_faqs" ||
            value == "edit product_faqs" ||
            value == "delete product_faqs"
        ) {
...
function calculate_discount() {
    ...
    $("#amount_paid").attr("min", amount);
    $("#amount_paid").attr("max", amount);
...
function enable_facebook_social_login($element) {
    "use strict";
    let value = $($element).val();
    if (value == "enable") {
        $("#facebook_social_block").removeClass("d-none");
        $("#facebook_client_id").attr("required", true);
        $("#facebook_client_secret").attr("required", true);
        $("#facebook_callback_url").attr("required", true);
    } else {
        $("#facebook_social_block").addClass("d-none");
        $("#facebook_client_id").attr("required", false);
        $("#facebook_client_secret").attr("required", false);
        $("#facebook_callback_url").attr("required", false);
    }
}

function enable_google_social_login($element) {
    "use strict";
    let value = $($element).val();
    if (value == "enable") {
        $("#google_social_block").removeClass("d-none");
        $("#google_client_id").attr("required", true);
        $("#google_client_secret").attr("required", true);
        $("#google_callback_url").attr("required", true);
    } else {
        $("#google_social_block").addClass("d-none");
        $("#google_client_id").attr("required", false);
        $("#google_client_secret").attr("required", false);
        $("#google_callback_url").attr("required", false);
    }
}
