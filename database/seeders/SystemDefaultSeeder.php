...
class SystemDefaultSeeder extends Seeder
{
    public function run()
    {
        ...
        $user = User::where('email', 'admin@mail.com')->count();
        ...
        if ($user == 0) {
            ...
            Permission::create(['name' => 'show expense']);
            Permission::create(['name' => 'add expense']);
            Permission::create(['name' => 'edit expense']);
            Permission::create(['name' => 'delete expense']);

            Permission::create(['name' => 'show expense_category']);
            Permission::create(['name' => 'add expense_category']);
            Permission::create(['name' => 'edit expense_category']);
            Permission::create(['name' => 'delete expense_category']);

            Permission::create(['name' => 'show assets']);
            Permission::create(['name' => 'add assets']);
            ...
            //Members trial
            Permission::create(['name' => 'show members_trial']);
            Permission::create(['name' => 'add members_trial']);
            Permission::create(['name' => 'edit members_trial']);
            Permission::create(['name' => 'delete members_trial']);

            //Members trial
            Permission::create(['name' => 'show members_enquiry']);
            Permission::create(['name' => 'add members_enquiry']);
            Permission::create(['name' => 'edit members_enquiry']);
            Permission::create(['name' => 'delete members_enquiry']);

            Permission::create(['name' => 'show trainers']);
            Permission::create(['name' => 'add trainers']);
            Permission::create(['name' => 'edit trainers']);
            Permission::create(['name' => 'delete trainers']);

            // create board permissions
            Permission::create(['name' => 'show branch']);
            Permission::create(['name' => 'add branch']);
            Permission::create(['name' => 'edit branch']);
            Permission::create(['name' => 'delete branch']);

            Permission::create(['name' => 'show reminders']);
            Permission::create(['name' => 'add reminders']);
            ...
            Permission::create(['name' => 'show expenses_categories']);
            Permission::create(['name' => 'add expenses_categories']);
            Permission::create(['name' => 'edit expenses_categories']);
            Permission::create(['name' => 'delete expenses_categories']);

            //Additional permission
            Permission::create(['name' => 'show qrcode']);
            Permission::create(['name' => 'show collect_part_payments']);
            Permission::create(['name' => 'show customer_renew']);
            Permission::create(['name' => 'show attendance']);

            Permission::create(['name' => 'show report']);
            Permission::create(['name' => 'show sales_report']);
            Permission::create(['name' => 'show expiry_report']);
            Permission::create(['name' => 'show collection_report']);
            Permission::create(['name' => 'show balance_report']);
            Permission::create(['name' => 'show attendance_report']);
            Permission::create(['name' => 'show pending_payments']);

            $vendor_role = Role::firstOrCreate(['name' => 'vendor']);
            $vendor_role->givePermissionTo(Permission::all());
            ...
            $privacy_policy="<p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p><p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p>
                            <h1>Interpretation and Definitions</h1><h2>Interpretation</h2><p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p><h2>Definitions</h2><p>For the purposes of this Privacy Policy:</p>
                            <ul>
                            ...
                            <li><p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to DigiRestro.</p></li>
                            ...
                            <li><p><strong>Country</strong> refers to: Alabama,  United States</p></li>
                            ...
                            </ul><h1>Collecting and Using Your Personal Data</h1><h2>Types of Data Collected</h2><h3>Personal Data</h3><p>While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:</p>
                            <ul><li><p>First name and last name</p></li><li><p>Phone number</p></li><li><p>Usage Data</p></li></ul>
                            <h3>Usage Data</h3>
                            ...
                            </ul><p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser.</p><p>We use both Session and Persistent Cookies for the purposes set out below:</p>
                            <ul><li><p><strong>Necessary / Essential Cookies</strong></p><p>Type: Session Cookies</p><p>Administered by: Us</p><p>Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p></li>
                            <li><p><strong>Cookies Policy / Notice Acceptance Cookies</strong></p><p>Type: Persistent Cookies</p><p>Administered by: Us</p><p>Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p></li>
                            <li><p><strong>Functionality Cookies</strong></p><p>Type: Persistent Cookies</p><p>Administered by: Us</p><p>Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</p></li>
                            ...
                            <h2>Use of Your Personal Data</h2><p>The Company may use Personal Data for the following purposes:</p><ul><li><p><strong>To provide and maintain our Service</strong>, including to monitor the usage of our Service.</p></li>
                            ...
                            <li><p><strong>For board transfers:</strong> We may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is among the assets transferred.</p></li>
                            ...
                            <li><strong>For board transfers:</strong> We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our board to another company.</li>
                            <li><strong>With Affiliates:</strong> We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.</li>
                            <li><strong>With board partners:</strong> We may share Your information with Our board partners to offer You certain products, services or promotions.</li>
            ...
            $terms="<p>Please read these terms and conditions carefully before using Our Service.</p><h1>Interpretation and Definitions</h1><h2>Interpretation</h2><p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p><h2>Definitions</h2><p>For the purposes of these Terms and Conditions:</p><ul><li><p><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where &quot;control&quot; means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</p></li><li><p><strong>Country</strong> refers to: New York,  United States</p></li><li><p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to digirestro.</p></li><li><p><strong>Device</strong> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</p></li><li><p><strong>Service</strong> refers to the Website.</p></li><li><p><strong>Third-party Social Media Service</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</p></li><li><p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p></li></ul><h1>Acknowledgment</h1>
                    ...
                    <h1>Termination</h1>
                    <p>We may terminate or suspend Your access immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</p><p>Upon termination, Your right to use the Service will cease immediately.</p><h1>Limitation of Liability</h1>
                    <p>Notwithstanding any damages that You might incur, the entire liability of the Company and any of its suppliers under any provision of this Terms and Your exclusive remedy for all of the foregoing shall be limited to the amount actually paid by You through the Service or 100 USD if You haven't purchased anything through the Service.</p>
                    <p>To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be liable for any special, incidental, indirect, or consequential damages whatsoever (including, but not limited to, damages for loss of profits, loss of data or other information, for board interruption, for personal injury, loss of privacy arising out of or in any way related to the use of or inability to use the Service, third-party software and/or third-party hardware used with the Service, or otherwise in connection with any provision of this Terms), even if the Company or any supplier has been advised of the possibility of such damages and even if the remedy fails of its essential purpose.</p>
            ...
            CmsPage::create(['slug' => 'privacy-policy', 'title' => 'Privacy policy', 'description' => $privacy_policy]);
            CmsPage::create(['slug' => 'terms-and-conditions', 'title' => 'Terms & conditions', 'description' => $terms]);
